            ...
            <div class="row">
                ...
                <div class="col-md-3" >
                    <div class="card hovercard">
                        ...
                        <div class="info">
                            <div class="title">
                                <a target="_blank" href="#"><?php echo $first_name;?></a>
                            </div>
                            <div class="desc"><?php echo "Admin"?></div>
                        </div>
                        <div class="bottom">
                ...
                <div class="col-md-9">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <button type="button" class="btn" data-toggle="modal" data-target="#body">
                          Post Notice
                        </button>
...
<!--modals-->
<div class="modal fade" id="body" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php include("modules/notice/addnotice.php");?>
    </div>
  </div>
</div>
